...
@Component({
  selector: 'app-aadhar-pay-receipt',
  templateUrl: './aadhar-pay-receipt.component.html',
  styleUrls: ['./aadhar-pay-receipt.component.css']
})
export class AadharPayReceiptComponent implements OnInit {
  balanceAmount:any = '0';
  firmname:any;
  ackno:any;
  message:any;
