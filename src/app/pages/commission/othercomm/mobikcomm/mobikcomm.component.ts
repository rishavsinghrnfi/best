...
@Component({
  selector: 'app-mobikcomm',
  templateUrl: './mobikcomm.component.html',
  styleUrls: ['./mobikcomm.component.css']
})
export class MobikcommComponent implements OnInit {
  userAutoComData: any;
  ...
  constructor(private fb: UntypedFormBuilder, private _auth: ApiService, private elementRef: ElementRef,  private loader:LoaderService,) {
