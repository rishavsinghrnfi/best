...
@Component({
  selector: 'app-paytm-wallet',
  templateUrl: './paytm-wallet.component.html',
  styleUrls: ['./paytm-wallet.component.css']
})
export class PaytmWalletComponent implements OnInit {
  userAutoComData: any;
